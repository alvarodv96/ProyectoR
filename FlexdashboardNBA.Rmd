...
```{r}
d3heatmap(nba_players_puntos, scale = "column", color = "YlOrRd", dendrogram="none")
```
...
```{r}
d3heatmap(nba_players_asistencias[,c("AST","STL","TO")], scale = "column", color = "YlOrRd", dendrogram="none")
```
...
```{r}
d3heatmap(nba_players_defensa[,c("TRB","STL","BLK")], scale = "column", color = "YlOrRd", dendrogram="none")
```
